             ...
             <section className="flex flex-col justify-between lg:flex-row lg:items-start">
               ...
               <aside className="mt-10 lg:w-1/3 lg:mt-0">
                 <div className="flex flex-col gap-4 text-base lg:text-xl">
                   <h1 className="text-2xl font-medium">Orders Summary</h1>
                   ...
                   <div>
                     <p className="flex justify-between w-full">
                       Delivery address: <span>Free</span>
                     </p>
                   ...
                   <p className="flex justify-between w-full borders-y borders-y-mutedgray py-4 lg:my-10">
                     Total: <span>${orders.amount.toFixed(2)}</span>
                   </p>
                 </div>
