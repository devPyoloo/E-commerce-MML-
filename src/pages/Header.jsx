  ...
  return (
    <>
      <header className="group relative flex justify-center items-center">
        <div className="absolute inset-0 bg-white transform -translate-y-full group-hover:translate-y-0 transition-all duration-300 ease-in-out z-0 rounded-b-2xl"></div>
