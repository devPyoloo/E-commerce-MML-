    ...
    <>
      <div className="flex items-center justify-evenly mx-20 mb-36">
        <div className="flex items-center justify-evenly gap-10">
          <section>
            <h1 className="font-bold text-7xl font-lora mb-5 mt-10">Elevate Your Beauty Routine with <span className="text-white before:block before:absolute before:-inset-1 before:-skew-y-3 before:bg-satpink relative inline-block">
            ...
            Discover curated cosmetics, skincare, and wellness products to enhance your glow. Explore and find your new essentials.
            </p>
